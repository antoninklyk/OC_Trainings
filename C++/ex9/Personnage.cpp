...
Personnage::Personnage() : m_vie(100), m_mana(100), m_arme("Epee rouille", 10) //constructeur basique
{

}

Personnage::Personnage(string nomArme, int degatsArme) : m_vie(100), m_mana(100), m_arme(nomArme, degatsArme) //constructeur surchargé
{
